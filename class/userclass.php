...
$stmt = $db->prepare("SELECT codigoUsuario FROM users WHERE (nombreCompleto=:email or email=:email) AND password=:hash_password"); 
...
if($count)
{
$_SESSION['codigoUsuario']=$data->codigoUsuario; // Storing user session value
return true;
}
else
{
